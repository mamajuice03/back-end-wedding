...
<?= $this->section('title') ?>
<title>Data Group &mdash; Wedding</title>
<?= $this->endSection() ?>
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="<?=site_url('groups')?>" class="btn btn-secondary"> 
                    Back
                </a>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        ...
                        <form action="<?=site_url('groups/delete2')?>" method="post" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
                            <?= csrf_field() ?>
                            <button href="" class="btn btn-danger btn-sm">Delete All Permanently</button>
                        </form>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 15%">
                                    ...
                                    <form action="<?=site_url('groups/delete2/'.$value->id_group)?>" method="post" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
                                        <?= csrf_field() ?>
                                        <button href="" class="btn btn-danger btn-sm">Delete Permanently</button>
                                    </form>
